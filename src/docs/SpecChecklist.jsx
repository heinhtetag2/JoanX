...
const CHAPTERS = [
  {
    ...
    items: [
      ...
      { id: 'F-03', title: 'Walk detection (1.2–2.5 Hz, 8 s sustain)', mode: 'Common', status: 'done',
        ...
        note: 'Accelerometer logic is engine-side, but now has a UI: a "Walking detection" card on Safety status shows the cadence band JoanX listens for and a live still/walking pill, with the ~10 s sustain rule spelled out (not on the bus/car).' },
