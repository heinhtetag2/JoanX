  ...
  },
  {
    ...
    items: [
      ...
      { id: 'F-18', title: 'Collection House (≥ 3 Rooms)', mode: 'Smart', status: 'done',
        screens: ['MyHouse.jsx'],
        note: 'DEVIATION, signed off. 3 rooms (Green / Town / Dream), each its own environment and decor set, and the count still meets "≥ 3". F-18 also says "Some Rooms unlock upon meeting conditions, expanding gradually" — that no longer happens: all three are free from the first walk. The unlock ladder (Town on a 5-day streak, Dream on 25h safe walking) and the seasonal Winter room were removed by product decision on 2026-07-17. Safe walking now buys characters and items, but no longer buys space.' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'A-8', title: 'Villain battles — 10 IP villains, Lv1–10', mode: 'Smart', status: 'done',
        screens: ['Battle.jsx', 'VillainDex.jsx'],
        note: 'Ping · Temo · Vortex · Moody · Chrono · Hexa · Shatter · Twist · Puppet (mid-boss) · Vilord (final boss) — not monsters but original IP characters, each personifying a real way a phone hooks a child (notifications, temptation, scrolling, emotion, time, habit, focus, thinking, mind control, total domination). Every row carries name · personality · story · look · battle characteristics as one approved set, so the dex, the battle screen and the art brief cannot drift apart. Sequential unlock, difficulty rising 60 → 440 power, 5 challenges/day. Beating Vilord pays a special reward and unlocks the ending. Seasonal villains are a server flag (set + enabled), and boss status is a role — appending a villain after Vilord can never steal the finale.' },
