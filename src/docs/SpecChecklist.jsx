...
const CHAPTERS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'F-09', title: 'Character message (bottom, ~20% height, 1.5 s)', mode: 'Common', status: 'done',
        screens: ['WarningOverlay.jsx'],
        note: 'Dedicated timed toast: bottom-center, ~20% screen height, pops for 1.5 s and repeats on a 3 s interval, cycling short nudges (“Eyes up!” / “Phone away for now” / “Look ahead!”) with a one-tap “I looked up” response.' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'A-7', title: 'Room decoration (wallpaper, furniture…)', mode: 'Smart', status: 'done',
        screens: ['DecorateRoom.jsx'], note: 'Point-bought decor by category, wallpaper colours, and placeable ornaments with a live preview.' },
      { id: 'A-12', title: 'Room styles — 3 switchable looks (new)', mode: 'Smart', status: 'done',
        screens: ['DecorateRoom.jsx'],
        note: 'Added requirement: each room can switch between 3 full styles — Cozy (warm wood), Modern (cool/clean), Playful (dotted wall + pink floor). The style re-skins the whole room (wall treatment + floor), is tinted by the chosen wallpaper, previews live, and saves per room.' },
