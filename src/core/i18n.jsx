...
const KO = {
  ...
  "JoanX only pings you for safety and your child's progress.": '조안X는 안전과 아이의 소식만 알려드려요.',
  ...
  'Weekly activity': '주간 활동', 'Build safer habits with Mina': '미나와 안전 습관 키우기',
  'Stopped when warned': '경고 시 멈춤', 'Safe walking': '안전 걷기', 'Avg. response': '평균 반응', 'Safe streak': '안전 연속',
  ...
  'Have an invite code?': '초대 코드가 있으신가요?', 'Enter your invite code': '초대 코드를 입력하세요',
  'The parent who invited you can find this under Family in their JoanX app.': '초대한 보호자의 JoanX 앱 → 가족 메뉴에서 이 코드를 확인할 수 있어요.',
  'That code doesn’t match — check with the parent who sent it.': '코드가 일치하지 않아요 — 보낸 보호자에게 다시 확인해 주세요.',
  ...
  'Before you go, please confirm you understand what this does.': '삭제하기 전에 아래 내용을 확인하고 동의해 주세요.',
  'My account and all its data will be permanently deleted.': '내 계정과 모든 데이터가 영구적으로 삭제돼요.',
  'Every linked child device will be unlinked.': '연결된 모든 자녀 기기의 연동이 해제돼요.',
  'This action can’t be undone.': '이 작업은 되돌릴 수 없어요.',
  'Deleting your account removes your profile, every child’s weekly reports, safety history, and app settings from JoanX. None of it can be recovered once it’s gone — if you’d like a copy first, use Export my data before you continue.':
    '계정을 삭제하면 내 프로필과 모든 자녀의 주간 리포트, 안전 기록, 앱 설정이 JoanX에서 삭제돼요. 한번 삭제되면 복구할 수 없으니, 자료를 먼저 보관하고 싶다면 계속하기 전에 "내 데이터 내보내기"를 이용해 주세요.',
  'Each child device connected to your account loses its pairing immediately. Safety monitoring — walking detection, warnings, and alerts — stops on that device until it’s paired with a different guardian account.':
    '계정에 연결된 모든 자녀 기기의 페어링이 즉시 해제돼요. 걷기 감지, 경고, 알림 등 안전 모니터링은 다른 보호자 계정과 다시 연결하기 전까지 멈춰요.',
  'There’s no recovery window. As soon as you confirm with the verification code on the next step, deletion starts right away and can’t be reversed or cancelled.':
    '되돌릴 수 있는 유예 기간은 없어요. 다음 단계에서 인증번호로 확인하는 즉시 삭제가 시작되며, 취소하거나 되돌릴 수 없어요.',
  'to confirm it’s you before deleting your account.': '계정을 삭제하기 전에 본인 확인을 위해 보냈어요.',
  'Step 1 of 3': '1/3 단계', 'Step 2 of 3': '2/3 단계', 'Step 3 of 3': '3/3 단계',
  'Why are you leaving?': '어떤 이유로 삭제하시나요?',
  'Optional, but it helps us make JoanX better.': '선택 사항이지만, 더 나은 JoanX를 만드는 데 도움이 돼요.',
  'My child no longer uses JoanX': '아이가 더 이상 JoanX를 사용하지 않아요',
  'Switching to another app': '다른 서비스로 옮겨요',
  'Too complicated to use': '사용하기 너무 복잡해요',
  'Concerned about privacy': '개인정보가 걱정돼요',
