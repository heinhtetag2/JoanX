...
const notifSeed = (c) => [
  ...
  { id: 'n6', when: 'earlier', type: 'battle', icon: 'swords', color: THEME.camping, bg: THEME.campingBg, t: 'You beat Vortex', s: '+120 points earned.', time: 'Yest.', unread: false, go: 'battle' },
